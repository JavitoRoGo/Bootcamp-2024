...
//: ## Sumatorio de los números impares hasta N
//: Uso de bucle for-in para recorrer los N números y calcular el sumatorio.
//: Filtrar los números impares usando el módulo o resto de la división.
...
print("La suma de los números impares hasta \(num) es \(suma)")
